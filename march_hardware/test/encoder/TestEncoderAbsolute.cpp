...
protected:
  ...
  march::EncoderAbsolute encoder = march::EncoderAbsolute(resolution, lower_limit, upper_limit, lower_limit_rad,
...
{
  ASSERT_THROW(march::EncoderAbsolute(0, this->lower_limit, this->upper_limit, this->lower_limit_rad,
...
{
  ASSERT_THROW(march::EncoderAbsolute(50, this->lower_limit, this->upper_limit, this->lower_limit_rad,
                                      this->upper_limit_rad, this->lower_soft_limit_rad, this->upper_soft_limit_rad),
               march::error::HardwareException);
}
...
{
  ASSERT_THROW(march::EncoderAbsolute(this->resolution, this->lower_limit, this->upper_limit, this->lower_limit_rad,
